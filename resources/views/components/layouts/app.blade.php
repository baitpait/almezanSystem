    ...
    <div class="drawer lg:drawer-open">
        ...
        <div class="drawer-side">
            ...
            <aside class="w-64 bg-gradient-to-b from-blue-600 to-blue-700 shadow-2xl h-screen flex flex-col">
                ...
                {{-- Navigation Menu --}}
                <ul class="sidebar-menu flex flex-col p-4 gap-1 flex-1 overflow-y-auto">
                    {{-- Dashboard --}}
                    <li>
                    ...
                    @canany(['view.patients', 'view.appointments', 'view.assessment', 'view.operations'])
                    ...
                    {{-- Billing Section --}}
                    @canany(['view.invoices', 'view.services'])
                    <li class="pt-2 mt-2 border-t border-blue-500/30">
                        <span class="text-blue-200 text-xs font-semibold uppercase tracking-wider px-4 py-1.5 flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
