    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        ...
        <div class="card-modern mb-8">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                @can('create.patients')
                <a href="{{ route('patients.index') }}?create=1" class="btn-add btn-action flex items-center justify-center gap-2">
                ...
                <a href="{{ route('appointments.index') }}?create=1" class="btn-add btn-action flex items-center justify-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                    </svg>
                ...
                @can('create.invoices')
                <a href="{{ route('invoices.index') }}?create=1" class="btn-add btn-action flex items-center justify-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <a href="{{ route('appointments.index') }}" class="btn-add btn-action flex items-center justify-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                    </svg>
                ...
                <div class="p-12 text-center">
                    <div class="max-w-md mx-auto">
                        ...
                        <div class="flex flex-wrap gap-3 justify-center">
                            ...
                            @endcan
                            <a href="{{ route('appointments.index') }}" class="btn-primary flex items-center gap-2">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                                </svg>
                                <span>View All Appointments</span>
