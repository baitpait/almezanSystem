                        ...
                        <div class="relative inline-block" data-dropdown-container="{{ $appointment->id }}">
                            ...
                            <div class="simple-dropdown-menu" 
                                ...
                                <ul class="dropdown-menu-list">
                                    ...
                                    <li>
                                        <a href="{{ route('appointments.index', ['filter_patient_id' => $appointment->patient_id]) }}"
                                    ...
                                    @endcan
                                    @if($appointment->visit_type === 'Assessment' && auth()->user()->can('view.assessment'))
                                    <li>
                                        <button type="button" class="dropdown-menu-item dropdown-menu-item-view" wire:click="goToAssessment({{ $appointment->id }})" onclick="closeSimpleDropdown({{ $appointment->id }})">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="dropdown-menu-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    ...
                                    @elseif($appointment->visit_type === 'Operation' && auth()->user()->can('view.operations') && !auth()->user()->isSecretary())
                                    <li>
                                        <button type="button" class="dropdown-menu-item dropdown-menu-item-view" wire:click="goToOperationNote({{ $appointment->id }})" onclick="closeSimpleDropdown({{ $appointment->id }})">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="dropdown-menu-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
